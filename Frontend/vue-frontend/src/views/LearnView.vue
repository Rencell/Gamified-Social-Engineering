...
<template>
    ...
    <div class="p-2 sm:p-5">
        ...
        <div class="flex flex-col sm:flex-row gap-10 ">
                ...
                <RouterLink v-for="(lesson, index) in learningStore.lessons" :key="lesson.id"
                    ...
                    <div>
                        <LessonCard :class="[lesson.locked
                            ...
                            :progress="learningStore.completionPercentage" :title="lesson.title" :image="lesson.image"
                            :bg="lesson.bg" :module-count="lesson.modules.length" :locked="lesson.locked"
            ...
            <DayStreak class="sticky top-0 self-start" />
        </div>
