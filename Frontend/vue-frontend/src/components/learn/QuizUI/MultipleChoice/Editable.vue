                ...
                <CardContent class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="mt-3 p-3 border rounded-lg bg-muted/50">
                            <img :src="previewUrl || useImageUrl(quizData.image) || '/placeholder.svg'"
                                alt="Question preview" class="max-w-full h-auto max-h-48 rounded mx-auto"
                                @error="hideImage" />

                        </div>

                        <div class="flex justify-end mt-4"><Button @click="handleUpload" :disabled="!changeUpdate">Save
                                Image</Button></div>
                    </div>
                </CardContent>
            </Card>
            ...
            <Card class="bg-background">
                ...
                <CardContent class="space-y-3">
                    <div v-for="(option, index) in quizData.options" :key="option.id"
                        ...
                        <Button v-if="quizData.options.length > 2" variant="outline" size="sm"
