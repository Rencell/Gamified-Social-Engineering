<template>
    <div v-if="isAnswered" class="sticky bottom-0 z-50 ms-3 flex flex-col gap-6 animate-in fade-in bg-background border-t-2 border-ternary w-full sm:w-4xl p-5 rounded-xl backdrop-blur shadow-md">
        <div>
            <div class="mb-2">
